...
export default class Feed extends Component{
    ...
    registerToSocket=()=> {
        const socket = io('http://192.168.0.3:3003');
        ...
        <View style={style.container}>
            ...
            renderItem={({item})=> (
                <View style={style.feedItem}>
                    ...
                    <Image style={style.feedImage} source={{uri:`http://192.168.0.3:3003/files/${item.image}`}} />
                    <View style={style.feedItemFooter}>
                        ...
                        <Text style={style.descriptions}>{item.descriptions}</Text>
